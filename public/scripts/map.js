...
function keydowned() {
  ...
  switch (d3.event.keyCode) {
    case 37: currentValue = Math.max(slider_x.domain()[0], slider_actual - slider_trail_length); break;
    case 39: currentValue = Math.min(slider_x.domain()[1], slider_actual + slider_trail_length); break;
    default: return;
  }
  update(currentValue);
  paused();
